...
const CreateProductAdmin = () => {
    ...
    const hendleCreateProduct = (e) => {
        ...
        axios.post('http://localhost:4000/product', bodyReques, { headers: { Authorization: `Bearer ${token}` } })
            .then(() => {
                alert('create data product success')
        ...
        <div>
            <Container className={style.container}>
                ...
                <div className={style.container2}>
                    ...
                    <button className={style.btnSubmit} type="submit" onClick={hendleCreateProduct}>Submit</button>
                </div>
            </Container>
        </div>
    )
